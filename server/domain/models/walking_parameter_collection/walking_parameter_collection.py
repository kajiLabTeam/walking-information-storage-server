...
class WalkingParameterCollection:
    ...
    def get_walking_parameters(self) -> List[WalkingParameter]:
        return self.__walking_parameters

    def add(self, walking_parameter: WalkingParameter):
        self.__walking_parameters.append(walking_parameter)

    def remove(self, walking_parameter: WalkingParameter):
