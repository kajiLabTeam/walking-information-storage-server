...
from config.const.extension import (
...
def get_gps_bucket_name(
    pedestrian_id: str, walking_information_id: str, gps_id: str
) -> str:
...
def get_accelerometer_bucket_name(
    pedestrian_id: str, walking_information_id: str, accelerometer_id: str
) -> str:
...
def get_ratio_wave_bucket_name(
    pedestrian_id: str, walking_information_id: str, ratio_wave_id: str
) -> str:
...
def get_atmospheric_pressure_bucket_name(
    pedestrian_id: str, walking_information_id: str, atmospheric_pressure_id: str
) -> str:
